...
const programsData = [
  ...
  },
  {
    ...
    programs: [
      ...
      { id: 63, title: "Program 63: Check if Binary String", description: "This program checks if a given string consists only of '0's and '1's, indicating if it's a binary string.", code: `def is_binary_str(input_str):\n    for i in input_str:\n        if i not in '01':\n            return False\n    return True\n\ninput_str = "1001110"\nif is_binary_str(input_str):\n    print(f"'{input_str}' is a binary string.")\nelse:\n    print(f"'{input_str}' is not a binary string.")\n\n# Expected Output:\n# '1001110' is a binary string.` },
